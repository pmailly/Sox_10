            ...
            for (String f : imageFiles) {
                ...
                for (Roi roi : rois) {
                    ...
                    if (sox.vessel){
                        ...
                        ImagePlus imgVessel =  new ImageCalculator().run("add", imgVessel1, imgVessel2);
                        ImagePlus imgVesselTube = sox.tubeness(imgVessel, roi);
                        vesselPop = sox.findVessel(imgVesselTube);
                    ...
                    sox.saveCellsImage(cellPop, vesselPop, imgCells, outDirResults+rootName+"_"+roi.getName()+".tif");
                ...
                if (series !=0)
                    options.setSeriesOn(series, false);
            }
            sox.closeResults();
